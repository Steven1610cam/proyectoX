...
@OptIn(ExperimentalMaterial3Api::class) // ExperimentalMaterial3Api para BadgedBox
@Composable
fun OrderScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                actions = {
                    // MODIFICACIÓN AQUÍ para el icono del carrito con insignia
                    BadgedBox(
                        badge = {
                            if (cartItemCount > 0) {
...
fun ProductListItem(
    ...
    Row(
        ...
        Column(modifier = Modifier.weight(1f)) {
            ...
            Text(
                // Reutilizando la función formatCurrency que creamos para CartScreen
                text = com.dynamite.proyectox.presentation.cart.formatCurrency(product.price),
                style = MaterialTheme.typography.bodyMedium,
                color = MaterialTheme.colorScheme.primary // Color naranja para precio
            )
        }
        Button(
            onClick = onAddClick,
...
fun OrderScreenPreview() {
    MaterialTheme { // Idealmente tu ProyectoXTheme
        ...
        OrderScreen(
            ...
            cartItemCount = 3, // <-- VALOR DE EJEMPLO PARA LA INSIGNIA EN LA PREVIEW
